...
from reg_transfo.algorithms.lightning_module_tests import LightningModuleTests
from reg_transfo.configs import Config
from reg_transfo.conftest import setup_with_overrides, skip_on_macOS_in_CI
from reg_transfo.datamodules.image_classification.cifar10 import CIFAR10DataModule
from reg_transfo.datamodules.image_classification.image_classification import (
    ImageClassificationDataModule,
)
from reg_transfo.main_test import experiment_commands_to_test
from reg_transfo.utils.env_vars import SLURM_JOB_ID
from reg_transfo.utils.testutils import IN_GITHUB_CI, run_for_all_configs_of_type
...
class TestImageClassifier(LightningModuleTests[ImageClassifier]):
    ...
    - `algorithm_config` will take the value `"image_classifier"`
        - This is because there is an `image_classifier.yaml` config file in reg_transfo/configs/algorithms
