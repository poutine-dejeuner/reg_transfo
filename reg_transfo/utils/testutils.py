...
from reg_transfo.utils.env_vars import NETWORK_DATASETS_DIR, SLURM_JOB_ID
from reg_transfo.utils.hydra_utils import get_outer_class
...
def get_config_loader():
    ...
    from reg_transfo.main import PROJECT_NAME
...
def get_target_of_config(
    ...
    if _cs is None:
        from reg_transfo.configs import cs as _cs
