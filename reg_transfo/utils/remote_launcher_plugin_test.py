...
# Use monkeypatch.setattr(reg_transfo.utils.remote_launcher_plugin, ..., that_mock)
...
import reg_transfo.utils.remote_launcher_plugin
from reg_transfo.main import PROJECT_NAME, main
from reg_transfo.main_test import CONFIG_DIR
from reg_transfo.utils import remote_launcher_plugin
from reg_transfo.utils.env_vars import SLURM_JOB_ID
from reg_transfo.utils.remote_launcher_plugin import RemoteSlurmLauncher
from reg_transfo.utils.testutils import IN_GITHUB_CI, IN_SELF_HOSTED_GITHUB_CI
...
def test_run_remote_job(argv: list[str], monkeypatch: pytest.MonkeyPatch):
    ...
    monkeypatch.setattr(
        reg_transfo.utils.remote_launcher_plugin, RemoteSlurmLauncher.__name__, launcher_mock
    )

    monkeypatch.setattr(sys, "argv", ["reg_transfo/main.py"] + argv)
