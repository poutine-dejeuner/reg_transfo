...
class Config:
    ...
    For more info, see the [instantiate_algorithm][reg_transfo.main.instantiate_algorithm] function.
    """
    ...
    See the [MNISTDataModule][reg_transfo.datamodules.image_classification.mnist.MNISTDataModule] for an example.
    """
